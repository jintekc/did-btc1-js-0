...
import { Btc1Networks, DidBtc1IdTypes, PublicKeyBytes } from './btc1/crud/types.js';
...
export class DidBtc1 implements DidMethod {
  ...
  public static async update({
    ...
    const didUpdateInvocation = Btc1Update.invokePayload({ identifier, updatePayload, verificationMethod: vm, options });
