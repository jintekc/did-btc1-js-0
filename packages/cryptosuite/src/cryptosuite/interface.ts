import { CanonicalizableObject, HashHex, SignatureBytes } from '@did-btc1/common';
...
import { CanonicalizedProofConfig, Proof, SecureDocument, VerificationResult } from '../types/di-proof.js';
